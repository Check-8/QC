...
public class CreateTreeHelper {
	...
	/*
	 * This takes a String describing a tree and converts it into a TreeDefinition. The format of the string is a series
	 * of edges represented as pairs of string separated by semi-colons. Each pair is comma separated. The first
	 * substring in the pair is the parent, the second is the child. The first edge parent must be the root of the tree.
	 *
	 ...
	 * This takes a String describing a tree and converts it into a TreeDefinition. The format of the string is a series
	 * of edges represented as pairs of string separated by semi-colons. Each pair is comma separated. The first
	 * substring in the pair is the parent, the second is the child.
	 *
	 * For example: "a-b;a-c;c-d;c-e;c-f;"
	 */
